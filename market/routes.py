    ...
    if request.method == 'POST':
        ...
        if p_item_object:
            if current_user.can_purchase(p_item_object):
                ...
                flash(f'Unfortunately, you dont have enough money { p_item_object.name }', category='danger')
        ...
        if s_item_object:
            if current_user.can_sell(s_item_object):
                ...
                flash(f'Something wroing in selling { p_item_object.name }', category='danger')
...
def register_page():
    ...
    if form.validate_on_submit():
        ...
        return redirect(url_for('market_page'))
    if form.errors != {}: # If there is no error from validations
